...
export const PRODUCTS: ProductItem[] = [
  {
    ...
    coreResponsibility: [
      ...
      'スマート先行ディフェンスによる蓄電池先回りと空調停止抑止の連動',
      '通常協調区間における需要トレンドに応じたバッテリーファースト多段制御',
      '残余枠スマート急速チャージによる安全な残存電力量の最大活用',
      '境界フェイルセーフガードによる時限跨ぎの充電超過防止',
      '通信断・値異常時の安全側移行と長期一次証跡ログの自律保存'
    ],
    ...
    keyFeatures: [
      {
        title: '30分スマート協調シーケンス',
        description: '電力会社の30分検針サイクルに同期。境界同期→先行ディフェンス→多段協調→残余枠チャージ→境界ガードの5段階で、空調を止めずにデマンドを自動防衛。',
        tag: '特許出願中コア技術'
      },
      {
        title: '放電前需要の復元（反実仮想）',
      ...
      {
        title: '単一ライター保護と責任分界',
        description: 'EMS制御指令の発行主体をSPAQ COREに一意化。他装置との競合書込みを防ぎ、予期せぬ動作を完全に排除。',
        tag: '安全設計'
      },
      {
        title: 'シャドーモードと監査ログ',
        description: '実機を動かさずに予測制御性能を検証可能。判断理由コード（Reason Code）を付与し、すべての制御判断を長期にわたり追跡可能。',
        tag: '検証・追跡性'
      }
    ],
    specifications: [
      ...
      { label: 'ログ保全', value: 'イベント・制御証跡を不揮発メモリに長期保存し、事後検証に活用' },
    ...
    faq: [
      ...
      },
      {
        ...
        answer: '通信断や上位系異常を検知した瞬間、SPAQ COREは安全側待機モード（充電禁止・必要最小限の自律安全放電等）に移行し、設備トラブルを防止します。ログは装置内に長期にわたり蓄積され、復旧後に追跡可能です。'
      },
      {
